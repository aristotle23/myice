...
class FirebaseStubTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @var FirebaseStub
     */
    ...
    const UPDATED_URI = 'https://myice5050.firebaseio.com/';
    const UPDATED_TOKEN = 'Pearh4ykZdRJMxJcA9oODcqXmBr4uMs3cc1pQSFG';
    const UPDATED_TIMEOUT = 30;

    const INSECURE_URL = 'https://myice5050.firebaseio.com/';
