...
$message = "Assign password to your account";
if(isset($_REQUEST['submit']) && $_REQUEST['submit'] == "save"){

    $Admin = new Admin();
    if($Admin->newPwd($_SESSION['email'],$_REQUEST['pwd'],$_REQUEST['repwd'])){
        header("location: index.php?logout=true");
    }else{
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    ...
                    <div class="row">
                        <div class="col-xs-4">
                            <button class="btn btn-block bg-pink waves-effect" name="submit" value="save" type="submit">Save</button>
                        </div>
                    </div>
                </form>
            </div>
