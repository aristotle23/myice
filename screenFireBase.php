    ...
    <div class="leftsidebarwrapper">
        ...
        ?>
                  ...
                  <div class="panicdropdown">
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle"  style="background:white;color: #444444;padding: 2px 20px;border: 2px solid transparent;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          Select Emergency
                        </button>
