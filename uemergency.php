            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                <?php echo $userInfo['name']. " Emergencies" ?>
                            </h2>
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    $emergencies = $emergency->getUserEmergency($_REQUEST['uid']);
                                    foreach ($emergencies as $info){

                                        echo "<tr>";
                                        echo "<td>".$info['date']."</td>";
                                        echo "<td>".$info['type']."</td>";
                                        $emergencyLoc = $emergency->getLocation($info["id"]);
                                        $origin = $emergencyLoc['lat'] .",".$emergencyLoc['lng'];
                                        $link = "screen.php?eid=".$info['id']."&type=".$info['type_id']."&latlng=".$origin."&date=".$info["date"];
                                        echo "<td><a class='btn btn-danger btn-circle waves-effect mediaBtn waves-circle waves-float' href='".$link.
                                            "' ><i class=\"material-icons\" >tv</i>  </a></td>";
